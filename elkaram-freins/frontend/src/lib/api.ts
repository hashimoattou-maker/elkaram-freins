...
export const products = {
  ...
  importExcel: (file: File) => {
    ...
    fd.append("file", file);
    return api.post<ImportResult>("/products/import-excel", fd).then((r) => r.data);
  },
...
export const clients = {
  ...
  importExcel: (file: File) => {
    const fd = new FormData();
    fd.append("file", file);
    return api.post<ImportResult>("/clients/import", fd).then((r) => r.data);
  },
...
export const suppliers = {
  ...
  importExcel: (file: File) => {
    const fd = new FormData();
    fd.append("file", file);
    return api.post<ImportResult>("/suppliers/import-excel", fd).then((r) => r.data);
  },
